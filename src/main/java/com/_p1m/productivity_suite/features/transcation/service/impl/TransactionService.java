...
//    List<TransactionResponse> retrieveAll (final String authHeader);
    ...
    List<TransactionResponse> searchTransactions(final String authHeader, final Long categoryId, final String description, final Long transactionDate, final BigDecimal fromAmount, final BigDecimal toAmount, final int page, final int size);
