...
public interface NoteService {
    void createNote(final CreateNoteRequest createNoteRequest);
    List<NoteResponse> retrieveAllByUser(Long userId);
    NoteResponse retrieveOne(final Long id, Long userId);
